...
function AppSent(props) {
  
    // const [modalAppSentVisible, setModalAppSentVisible] = useState(true);
            ...
            <View style={styles.centeredView}>
              <Pressable style={{height:'100%',flex:1,justifyContent:'center'}} onPress={modalFunc}>
                <View style={styles.modalView}>
                    <Text style={[styles.modalText,{fontSize:20,fontWeight:'bold'}]}>Application Sent!</Text>
                    <View style={{paddingHorizontal:20,marginVertical:20}}>
                    <Text>Your application has been successfully saved, you may continue with your application at any point! Just click on properties.</Text>
                    </View>
