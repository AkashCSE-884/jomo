        ...
        >
          ...
          <Pressable style={{height:'100%',flex:1,justifyContent:'center'}} onPress={modalFunc}>
                <View style={styles.modalView}>
                    <Text style={[styles.modalText,{fontSize:20,fontWeight:'bold'}]}>Application Saved!</Text>
                    <View style={{paddingHorizontal:20,marginBottom:20}}>
                    <Text style={{textAlign:'center'}}>Your application has been successfully saved, you may continue with your application at any point! Just click on properties.</Text>
                    </View>
