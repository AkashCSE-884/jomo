...
function SignLeaseCongrats(props) {
          ...
          <View style={styles.modalView}>
            ...
            <View style={{ paddingHorizontal: 20, marginBottom: 20 }}>
              <Text style={{ textAlign: "center" }}>
                You have successfully signed your lease. We will notify you when
                the signed lease will be ready for you to view.
              </Text>
            </View>
...
export default SignLeaseCongrats;
